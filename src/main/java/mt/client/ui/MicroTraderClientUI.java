...
public class MicroTraderClientUI extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		unfulfilledOrdersTable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
		...
		myOrdersTable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
				...
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(layout.createSequentialGroup()
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										...
										.addComponent(jTabbedPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 634,
												Short.MAX_VALUE))
								.addContainerGap()));
				...
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
								layout.createSequentialGroup().addContainerGap()
										.addComponent(jTabbedPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 411,
												Short.MAX_VALUE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(panel).addGap(6, 6, 6)));

		// *************************

		//
		// javax.swing.GroupLayout layout1 = new
	...
	private void connectActionPerformed(java.awt.event.ActionEvent evt) {
		if (!controller.isConnected()) {
			...
			JOptionPane.showMessageDialog(this,
					"You are already connected to a server. \nNavigate to File > Disconnect before connecting with new nickname.",
	...
	private void placeOrderBtnActionPerformed(java.awt.event.ActionEvent evt) {
		if (controller.isConnected()) {
			...
			JOptionPane.showMessageDialog(this,
					"You must be connected to a server to place orders. \nNavigate to File > Connect.", "Warning",
					JOptionPane.WARNING_MESSAGE);
		}
